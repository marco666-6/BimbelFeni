...
@section('content')
                    ...
                    <tbody>
                        @foreach($users as $index => $user)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <img src="{{ $user->foto_profil_url }}" alt="{{ $user->username }}" class="rounded-circle"
                                        width="40" height="40">
                                </td>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $user->role == 'admin' ? 'danger' : ($user->role == 'orangtua' ? 'info' : 'success') }}">
                                        {{ ucfirst($user->role) }}
                                    </span>
                                </td>
                                <td>
    ...
    <!-- Edit User Modals (Individual for each user) -->
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="role" required>
                                    ...
                                    <option value="orangtua" {{ $user->role == 'orangtua' ? 'selected' : '' }}>Orang Tua
                                    </option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="foto_profil" accept="image/*">
                                @if($user->foto_profil)
                                    <small class="text-muted">Foto saat ini: {{ basename($user->foto_profil) }}</small>
                                @endif
                            </div>
                        </div>
                        <div class="modal-footer">
